...
const Bigcan = () => {
    return (
        ...
        <p>Первые заморозки остро ставят перед водителями вопрос по качественной очистке лобового стекла. Для подобной процедуры необходимо выбрать стеклоомыватель или незамерзайку. Её разрабатывают специально для использования во время низких температур. Но некоторые компании недобросовестно относятся к созданию таких веществ, что может повлиять на работу системы очистки авто.<br />
          ...
          <br />
          Купить незамерзайку можно онлайн, оформив доставку и выбрав способ оплаты. Покупка возможна оптом и в розницу. Cтеклоомыватель без запаха с доставкой по СПб мы доставим в день покупки! Гарантированное качество, низкие цены. Для постоянных клиентов скидки.</p>
          </div>
        </div>
      </section>
    )
